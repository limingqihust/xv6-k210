...
/home/lzq/Desktop/oscomp/test/build/riscv64/fork：     文件格式 elf64-littleriscv
...
void test_fork(void){
    ...
    TEST_START(__func__);
    1010:	2f2000ef          	jal	1302 <puts>
    1014:	00001517          	auipc	a0,0x1
    1018:	f5c50513          	add	a0,a0,-164 # 1f70 <__func__.0>
    101c:	2e6000ef          	jal	1302 <puts>
    1020:	00001517          	auipc	a0,0x1
    1024:	eb850513          	add	a0,a0,-328 # 1ed8 <__clone+0x46>
    1028:	2da000ef          	jal	1302 <puts>
    int cpid, wstatus;
    cpid = fork();
    102c:	45d000ef          	jal	1c88 <fork>
    assert(cpid != -1);
    1030:	57fd                	li	a5,-1
    ...
    103c:	533000ef          	jal	1d6e <wait>
	printf("  parent process. wstatus:%d\n", wstatus);
    1040:	45b2                	lw	a1,12(sp)
    1042:	00001517          	auipc	a0,0x1
    1046:	ec650513          	add	a0,a0,-314 # 1f08 <__clone+0x76>
    104a:	2da000ef          	jal	1324 <printf>
    }else{
    ...
    1052:	ef250513          	add	a0,a0,-270 # 1f40 <__clone+0xae>
    1056:	2ac000ef          	jal	1302 <puts>
    105a:	00001517          	auipc	a0,0x1
    105e:	f1650513          	add	a0,a0,-234 # 1f70 <__func__.0>
    1062:	2a0000ef          	jal	1302 <puts>
    1066:	00001517          	auipc	a0,0x1
    106a:	e7250513          	add	a0,a0,-398 # 1ed8 <__clone+0x46>
    106e:	294000ef          	jal	1302 <puts>
}
    ...
    107c:	e7050513          	add	a0,a0,-400 # 1ee8 <__clone+0x56>
    1080:	51e000ef          	jal	159e <panic>
	printf("  child process.\n");
    1084:	00001517          	auipc	a0,0x1
    1088:	ea450513          	add	a0,a0,-348 # 1f28 <__clone+0x96>
    108c:	298000ef          	jal	1324 <printf>
	exit(100);
    1090:	06400513          	li	a0,100
    1094:	417000ef          	jal	1caa <exit>
...
int main(void){
    ...
    test_fork();
    109e:	f67ff0ef          	jal	1004 <test_fork>
    return 0;
    10a2:	60a2                	ld	ra,8(sp)
    10a4:	4501                	li	a0,0
    10a6:	0141                	add	sp,sp,16
    10a8:	8082                	ret
...
{
    10ae:	1141                	add	sp,sp,-16
	exit(main(argc, argv));
    10b0:	05a1                	add	a1,a1,8
{
    10b2:	e406                	sd	ra,8(sp)
	exit(main(argc, argv));
    10b4:	fe7ff0ef          	jal	109a <main>
    10b8:	3f3000ef          	jal	1caa <exit>
	return 0;
}
    ...
    10c6:	f406                	sd	ra,40(sp)
{
    ...
    if (sign && (sign = xx < 0))
    10c8:	12054863          	bltz	a0,11f8 <printint.constprop.0+0x134>
    ...
    10d4:	eb068693          	add	a3,a3,-336 # 1f80 <digits>
    buf[16] = 0;
    10d8:	00010c23          	sb	zero,24(sp)
        buf[i--] = digits[x % base];
    10dc:	0005871b          	sext.w	a4,a1
    10e0:	1782                	sll	a5,a5,0x20
    10e2:	9381                	srl	a5,a5,0x20
    ...
    10f2:	1ab56663          	bltu	a0,a1,129e <printint.constprop.0+0x1da>
        buf[i--] = digits[x % base];
    ...
    110c:	12e86c63          	bltu	a6,a4,1244 <printint.constprop.0+0x180>
        buf[i--] = digits[x % base];
    ...
    1126:	12e5e863          	bltu	a1,a4,1256 <printint.constprop.0+0x192>
        buf[i--] = digits[x % base];
    ...
    1140:	12e86463          	bltu	a6,a4,1268 <printint.constprop.0+0x1a4>
        buf[i--] = digits[x % base];
    ...
    115a:	12e5e063          	bltu	a1,a4,127a <printint.constprop.0+0x1b6>
        buf[i--] = digits[x % base];
    ...
    1174:	0ae86f63          	bltu	a6,a4,1232 <printint.constprop.0+0x16e>
        buf[i--] = digits[x % base];
    ...
    118e:	0ee5ef63          	bltu	a1,a4,128c <printint.constprop.0+0x1c8>
        buf[i--] = digits[x % base];
    ...
    11a8:	0ee86d63          	bltu	a6,a4,12a2 <printint.constprop.0+0x1de>
        buf[i--] = digits[x % base];
    ...
    11c2:	0ee5e963          	bltu	a1,a4,12b4 <printint.constprop.0+0x1f0>
        buf[i--] = digits[x % base];
    ...
    if (sign)
    11d6:	00055763          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    ...
    11f6:	8082                	ret
        x = -xx;
    11f8:	40a0063b          	negw	a2,a0
        buf[i--] = digits[x % base];
    11fc:	02b677bb          	remuw	a5,a2,a1
    1200:	00001697          	auipc	a3,0x1
    1204:	d8068693          	add	a3,a3,-640 # 1f80 <digits>
    buf[16] = 0;
    1208:	00010c23          	sb	zero,24(sp)
        buf[i--] = digits[x % base];
    120c:	0005871b          	sext.w	a4,a1
    1210:	1782                	sll	a5,a5,0x20
    1212:	9381                	srl	a5,a5,0x20
    1214:	97b6                	add	a5,a5,a3
    1216:	0007c783          	lbu	a5,0(a5)
    } while ((x /= base) != 0);
    121a:	02b6583b          	divuw	a6,a2,a1
        buf[i--] = digits[x % base];
    121e:	00f10ba3          	sb	a5,23(sp)
    } while ((x /= base) != 0);
    1222:	ecb67ae3          	bgeu	a2,a1,10f6 <printint.constprop.0+0x32>
        buf[i--] = '-';
    1226:	02d00793          	li	a5,45
    122a:	00f10b23          	sb	a5,22(sp)
        buf[i--] = digits[x % base];
    122e:	45b9                	li	a1,14
    1230:	bf55                	j	11e4 <printint.constprop.0+0x120>
    1232:	45a9                	li	a1,10
    if (sign)
    1234:	fa0558e3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    1238:	02d00793          	li	a5,45
    123c:	00f108a3          	sb	a5,17(sp)
        buf[i--] = digits[x % base];
    1240:	45a5                	li	a1,9
    1242:	b74d                	j	11e4 <printint.constprop.0+0x120>
    1244:	45b9                	li	a1,14
    if (sign)
    1246:	f8055fe3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    124a:	02d00793          	li	a5,45
    124e:	00f10aa3          	sb	a5,21(sp)
        buf[i--] = digits[x % base];
    1252:	45b5                	li	a1,13
    1254:	bf41                	j	11e4 <printint.constprop.0+0x120>
    1256:	45b5                	li	a1,13
    if (sign)
    1258:	f80556e3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    125c:	02d00793          	li	a5,45
    1260:	00f10a23          	sb	a5,20(sp)
        buf[i--] = digits[x % base];
    1264:	45b1                	li	a1,12
    1266:	bfbd                	j	11e4 <printint.constprop.0+0x120>
    1268:	45b1                	li	a1,12
    if (sign)
    126a:	f6055de3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    126e:	02d00793          	li	a5,45
    1272:	00f109a3          	sb	a5,19(sp)
        buf[i--] = digits[x % base];
    1276:	45ad                	li	a1,11
    1278:	b7b5                	j	11e4 <printint.constprop.0+0x120>
    127a:	45ad                	li	a1,11
    if (sign)
    127c:	f60554e3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    1280:	02d00793          	li	a5,45
    1284:	00f10923          	sb	a5,18(sp)
        buf[i--] = digits[x % base];
    1288:	45a9                	li	a1,10
    128a:	bfa9                	j	11e4 <printint.constprop.0+0x120>
    128c:	45a5                	li	a1,9
    if (sign)
    128e:	f4055be3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    1292:	02d00793          	li	a5,45
    1296:	00f10823          	sb	a5,16(sp)
        buf[i--] = digits[x % base];
    129a:	45a1                	li	a1,8
    129c:	b7a1                	j	11e4 <printint.constprop.0+0x120>
    i = 15;
    129e:	45bd                	li	a1,15
    12a0:	b791                	j	11e4 <printint.constprop.0+0x120>
        buf[i--] = digits[x % base];
    12a2:	45a1                	li	a1,8
    if (sign)
    12a4:	f40550e3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    12a8:	02d00793          	li	a5,45
    12ac:	00f107a3          	sb	a5,15(sp)
        buf[i--] = digits[x % base];
    12b0:	459d                	li	a1,7
    12b2:	bf0d                	j	11e4 <printint.constprop.0+0x120>
    12b4:	459d                	li	a1,7
    if (sign)
    12b6:	f20557e3          	bgez	a0,11e4 <printint.constprop.0+0x120>
        buf[i--] = '-';
    12ba:	02d00793          	li	a5,45
    12be:	00f10723          	sb	a5,14(sp)
        buf[i--] = digits[x % base];
    12c2:	4599                	li	a1,6
    12c4:	b705                	j	11e4 <printint.constprop.0+0x120>
...
{
    1302:	1141                	add	sp,sp,-16
    1304:	e406                	sd	ra,8(sp)
    1306:	e022                	sd	s0,0(sp)
    1308:	842a                	mv	s0,a0
    r = -(write(stdout, s, strlen(s)) < 0);
    130a:	574000ef          	jal	187e <strlen>
    130e:	862a                	mv	a2,a0
    1310:	85a2                	mv	a1,s0
    1312:	4505                	li	a0,1
    1314:	147000ef          	jal	1c5a <write>
}
    1318:	60a2                	ld	ra,8(sp)
    131a:	6402                	ld	s0,0(sp)
    r = -(write(stdout, s, strlen(s)) < 0);
    131c:	957d                	sra	a0,a0,0x3f
    return r;
    131e:	2501                	sext.w	a0,a0
}
    1320:	0141                	add	sp,sp,16
    1322:	8082                	ret
...
{
    1324:	7171                	add	sp,sp,-176
    1326:	f85a                	sd	s6,48(sp)
    1328:	ed3e                	sd	a5,152(sp)
    buf[i++] = '0';
    132a:	7b61                	lui	s6,0xffff8
    va_list ap;
    int cnt = 0, l = 0;
    ...
    132c:	18bc                	add	a5,sp,120
{
    ...
    134a:	02500913          	li	s2,37
        ...
        if (s[1] == 0)
            break;
        switch (s[1])
    134e:	07300a13          	li	s4,115
    1352:	07800a93          	li	s5,120
    buf[i++] = '0';
    1356:	830b4b13          	xor	s6,s6,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    135a:	00001997          	auipc	s3,0x1
    135e:	c2698993          	add	s3,s3,-986 # 1f80 <digits>
        if (!*s)
    1362:	00054783          	lbu	a5,0(a0)
    1366:	16078a63          	beqz	a5,14da <printf+0x1b6>
    136a:	862a                	mv	a2,a0
        for (a = s; *s && *s != '%'; s++)
    136c:	19278d63          	beq	a5,s2,1506 <printf+0x1e2>
    1370:	00164783          	lbu	a5,1(a2)
    1374:	0605                	add	a2,a2,1
    1376:	fbfd                	bnez	a5,136c <printf+0x48>
    1378:	84b2                	mv	s1,a2
        l = z - a;
    ...
    1380:	8622                	mv	a2,s0
    1382:	4505                	li	a0,1
    1384:	0d7000ef          	jal	1c5a <write>
        if (l)
    1388:	1a041463          	bnez	s0,1530 <printf+0x20c>
        if (s[1] == 0)
    138c:	0014c783          	lbu	a5,1(s1)
    1390:	14078563          	beqz	a5,14da <printf+0x1b6>
        switch (s[1])
    1394:	1b478063          	beq	a5,s4,1534 <printf+0x210>
    1398:	14fa6b63          	bltu	s4,a5,14ee <printf+0x1ca>
    139c:	06400713          	li	a4,100
    13a0:	1ee78063          	beq	a5,a4,1580 <printf+0x25c>
    13a4:	07000713          	li	a4,112
    13a8:	1ae79963          	bne	a5,a4,155a <printf+0x236>
            break;
        case 'x':
    ...
    buf[i++] = '0';
    13ae:	01611423          	sh	s6,8(sp)
    write(f, s, l);
    13b2:	4649                	li	a2,18
            printptr(va_arg(ap, uint64));
    13b4:	631c                	ld	a5,0(a4)
    13b6:	0721                	add	a4,a4,8
    13b8:	e03a                	sd	a4,0(sp)
    for (j = 0; j < (sizeof(uint64) * 2); j++, x <<= 4)
    13ba:	00479293          	sll	t0,a5,0x4
    13be:	00879f93          	sll	t6,a5,0x8
    13c2:	00c79f13          	sll	t5,a5,0xc
    13c6:	01079e93          	sll	t4,a5,0x10
    13ca:	01479e13          	sll	t3,a5,0x14
    13ce:	01879313          	sll	t1,a5,0x18
    13d2:	01c79893          	sll	a7,a5,0x1c
    13d6:	02479813          	sll	a6,a5,0x24
    13da:	02879513          	sll	a0,a5,0x28
    13de:	02c79593          	sll	a1,a5,0x2c
    13e2:	03079693          	sll	a3,a5,0x30
    13e6:	03479713          	sll	a4,a5,0x34
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13ea:	03c7d413          	srl	s0,a5,0x3c
    13ee:	01c7d39b          	srlw	t2,a5,0x1c
    13f2:	03c2d293          	srl	t0,t0,0x3c
    13f6:	03cfdf93          	srl	t6,t6,0x3c
    13fa:	03cf5f13          	srl	t5,t5,0x3c
    13fe:	03cede93          	srl	t4,t4,0x3c
    1402:	03ce5e13          	srl	t3,t3,0x3c
    1406:	03c35313          	srl	t1,t1,0x3c
    140a:	03c8d893          	srl	a7,a7,0x3c
    140e:	03c85813          	srl	a6,a6,0x3c
    1412:	9171                	srl	a0,a0,0x3c
    1414:	91f1                	srl	a1,a1,0x3c
    1416:	92f1                	srl	a3,a3,0x3c
    1418:	9371                	srl	a4,a4,0x3c
    ...
    for (j = 0; j < (sizeof(uint64) * 2); j++, x <<= 4)
    146e:	03879713          	sll	a4,a5,0x38
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1472:	9371                	srl	a4,a4,0x3c
    1474:	8bbd                	and	a5,a5,15
    ...
    14d6:	e8079ae3          	bnez	a5,136a <printf+0x46>
    }
    va_end(ap);
}
    ...
    14ea:	614d                	add	sp,sp,176
    14ec:	8082                	ret
        switch (s[1])
    14ee:	07579663          	bne	a5,s5,155a <printf+0x236>
            printint(va_arg(ap, int), 16, 1);
    ...
    14fc:	bc9ff0ef          	jal	10c4 <printint.constprop.0>
        s += 2;
    1500:	00248513          	add	a0,s1,2
    1504:	b7f9                	j	14d2 <printf+0x1ae>
    1506:	84b2                	mv	s1,a2
    1508:	a039                	j	1516 <printf+0x1f2>
        for (z = s; s[0] == '%' && s[1] == '%'; z++, s += 2)
    150a:	0024c783          	lbu	a5,2(s1)
    150e:	0605                	add	a2,a2,1
    1510:	0489                	add	s1,s1,2
    1512:	e72794e3          	bne	a5,s2,137a <printf+0x56>
    1516:	0014c783          	lbu	a5,1(s1)
    151a:	ff2788e3          	beq	a5,s2,150a <printf+0x1e6>
        l = z - a;
    ...
    1524:	8622                	mv	a2,s0
    1526:	4505                	li	a0,1
    1528:	732000ef          	jal	1c5a <write>
        if (l)
    152c:	e60400e3          	beqz	s0,138c <printf+0x68>
    1530:	8526                	mv	a0,s1
    1532:	bd05                	j	1362 <printf+0x3e>
            if ((a = va_arg(ap, char *)) == 0)
    1534:	6782                	ld	a5,0(sp)
    1536:	6380                	ld	s0,0(a5)
    1538:	07a1                	add	a5,a5,8
    153a:	e03e                	sd	a5,0(sp)
    153c:	cc21                	beqz	s0,1594 <printf+0x270>
            l = strnlen(a, 200);
    153e:	0c800593          	li	a1,200
    1542:	8522                	mv	a0,s0
    1544:	424000ef          	jal	1968 <strnlen>
    write(f, s, l);
    1548:	0005061b          	sext.w	a2,a0
    154c:	85a2                	mv	a1,s0
    154e:	4505                	li	a0,1
    1550:	70a000ef          	jal	1c5a <write>
        s += 2;
    1554:	00248513          	add	a0,s1,2
    1558:	bfad                	j	14d2 <printf+0x1ae>
    return write(stdout, &byte, 1);
    155a:	4605                	li	a2,1
    155c:	002c                	add	a1,sp,8
    155e:	4505                	li	a0,1
    char byte = c;
    1560:	01210423          	sb	s2,8(sp)
    return write(stdout, &byte, 1);
    1564:	6f6000ef          	jal	1c5a <write>
    char byte = c;
    ...
    158a:	b3bff0ef          	jal	10c4 <printint.constprop.0>
        s += 2;
    158e:	00248513          	add	a0,s1,2
    1592:	b781                	j	14d2 <printf+0x1ae>
                a = "(null)";
    1594:	00001417          	auipc	s0,0x1
    1598:	9bc40413          	add	s0,s0,-1604 # 1f50 <__clone+0xbe>
    159c:	b74d                	j	153e <printf+0x21a>

000000000000159e <panic>:
#include <stdlib.h>
#include <stdio.h>
#include <unistd.h>
...
void panic(char *m)
{
    159e:	1141                	add	sp,sp,-16
    15a0:	e406                	sd	ra,8(sp)
    puts(m);
    15a2:	d61ff0ef          	jal	1302 <puts>
    exit(-100);
}
    15a6:	60a2                	ld	ra,8(sp)
    exit(-100);
    15a8:	f9c00513          	li	a0,-100
}
    15ac:	0141                	add	sp,sp,16
    exit(-100);
    15ae:	adf5                	j	1caa <exit>
...
size_t strlen(const char *s)
{
    ...
    18a4:	6b85b583          	ld	a1,1720(a1) # 1f58 <__clone+0xc6>
    18a8:	00000617          	auipc	a2,0x0
    18ac:	6b863603          	ld	a2,1720(a2) # 1f60 <__clone+0xce>
    ...
    18dc:	00757713          	and	a4,a0,7
{
    ...
    190c:	66053503          	ld	a0,1632(a0) # 1f68 <__clone+0xd6>
    ...
    191e:	63e8b883          	ld	a7,1598(a7) # 1f58 <__clone+0xc6>
    1922:	00000817          	auipc	a6,0x0
    1926:	63e83803          	ld	a6,1598(a6) # 1f60 <__clone+0xce>
    192a:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19aa:	5b263603          	ld	a2,1458(a2) # 1f58 <__clone+0xc6>
    19ae:	00000817          	auipc	a6,0x0
    19b2:	5b283803          	ld	a6,1458(a6) # 1f60 <__clone+0xce>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a3e:	51e8b883          	ld	a7,1310(a7) # 1f58 <__clone+0xc6>
    1a42:	00000817          	auipc	a6,0x0
    1a46:	51e83803          	ld	a6,1310(a6) # 1f60 <__clone+0xce>
    1a4a:	431d                	li	t1,7
