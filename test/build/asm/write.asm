...
/home/lmq/Desktop/xv6-k210/test/build/riscv64/write:     file format elf64-littleriscv
...
void test_write(){
	...
	TEST_START(__func__);
    1012:	296000ef          	jal	ra,12a8 <puts>
    1016:	00001517          	auipc	a0,0x1
    101a:	f1250513          	addi	a0,a0,-238 # 1f28 <__func__.1191>
    101e:	28a000ef          	jal	ra,12a8 <puts>
    1022:	00001517          	auipc	a0,0x1
    1026:	e6e50513          	addi	a0,a0,-402 # 1e90 <__clone+0x44>
    102a:	27e000ef          	jal	ra,12a8 <puts>
	const char *str = "Hello operating system contest.\n";
	printf("write: %p", str);
    102e:	00001597          	auipc	a1,0x1
    1032:	e7258593          	addi	a1,a1,-398 # 1ea0 <__clone+0x54>
    1036:	00001517          	auipc	a0,0x1
    103a:	e9250513          	addi	a0,a0,-366 # 1ec8 <__clone+0x7c>
    103e:	28c000ef          	jal	ra,12ca <printf>

	int str_len = strlen(str);
    1042:	00001517          	auipc	a0,0x1
    1046:	e5e50513          	addi	a0,a0,-418 # 1ea0 <__clone+0x54>
    104a:	7e6000ef          	jal	ra,1830 <strlen>
    104e:	0005041b          	sext.w	s0,a0
	assert(write(STDOUT, str, str_len) == str_len);
    1052:	8622                	mv	a2,s0
    1054:	00001597          	auipc	a1,0x1
    1058:	e4c58593          	addi	a1,a1,-436 # 1ea0 <__clone+0x54>
    105c:	4505                	li	a0,1
    105e:	3b7000ef          	jal	ra,1c14 <write>
    1062:	00850863          	beq	a0,s0,1072 <test_write+0x6e>
    1066:	00001517          	auipc	a0,0x1
    106a:	e7250513          	addi	a0,a0,-398 # 1ed8 <__clone+0x8c>
    106e:	4e4000ef          	jal	ra,1552 <panic>
	TEST_END(__func__);
    1072:	00001517          	auipc	a0,0x1
    1076:	e8650513          	addi	a0,a0,-378 # 1ef8 <__clone+0xac>
    107a:	22e000ef          	jal	ra,12a8 <puts>
    107e:	00001517          	auipc	a0,0x1
    1082:	eaa50513          	addi	a0,a0,-342 # 1f28 <__func__.1191>
    1086:	222000ef          	jal	ra,12a8 <puts>
}
    108a:	6402                	ld	s0,0(sp)
    108c:	60a2                	ld	ra,8(sp)
	TEST_END(__func__);
    108e:	00001517          	auipc	a0,0x1
    1092:	e0250513          	addi	a0,a0,-510 # 1e90 <__clone+0x44>
}
    1096:	0141                	addi	sp,sp,16
	TEST_END(__func__);
    1098:	ac01                	j	12a8 <puts>
...
int main(void) {
	...
	test_write();
    109e:	f67ff0ef          	jal	ra,1004 <test_write>
	return 0;
}
